...
function buildEllisStack(
  ...
  const obligations: ObligationItem[] = [
    ...
    },
    {
      ...
      detail: "Injectable medication administration. PM/RN can turn this on for assigned staff.",
      sourcePage: null,
    ...
    },
    {
      ...
      detail: "Wheelchair and shower chair orders. Staff do not sign. PM tracks renewal.",
      sourcePage: 6,
      documentVersionId: versionId,
      enabled: true,
      frequency: "Annually",
